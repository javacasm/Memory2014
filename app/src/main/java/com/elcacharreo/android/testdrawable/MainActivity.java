...
public class MainActivity extends AppCompatActivity {
    ...
    void actualizaPuntuacion()
    {
        ...
        String strPuntuacion=res.getString(R.string.puntuacion);
        strPuntuacion+=Integer.toString(iPuntuacion);
        tvPuntos.setText(strPuntuacion);
    }
        ...
        else
        {
            ...
            if(cartas[iCartaPrimera]==cartas[iCartaSegunda]) // Acierto
            {
                ...
                if(iPuntuacion==rDibujos.length )
                {
                    ...
                    btStop.setText(R.string.VolverJugar);
                    crono.stop();
                }
            }
            else  // Hemos fallado
